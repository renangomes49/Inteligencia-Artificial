...
public class RomaniaMap {
	public static void main(String[] args) {
		...
		No no = grafo.buscaGulosaDeMelhorEscolha(args[0], heuristica.getDistancias());
		
		System.out.println("Estado objetivo: " + no.getEstado().getCidade());
		System.out.println("Caminho: " + grafo.descreverCaminho(args[0],heuristica.getDistancias()));
